...
\begin{solution}
    ...
    \end{subsolution}
    \begin{subsolution}
        Let the diameter of the wire be $\delta$, its density be $\rho_w$, the distance between the bridges be $L$, the radius of the metal cylinder be $r$ and the height of the metal cylinder be $h$. Also let the frequency with half the cylinder immersed be $f_1$ and the frequency with the entire cylinder immersed be $f_2$. Finally, let the densities of the metal cylinder and the liquid be $\rho_c$ and $\rho_l$ respectively.

        When the cylinder is half immersed, the tension is:
        \begin{align*}
            T_1&=\rho_c\pi r^2 h g - \rho_l \pi r^2 \frac{h}{2} g\\
            &=\pi r^2 h g \left(\rho_c-\frac{\rho_l}{2}\right)
        \end{align*}
        For a wave in a string, the speed is \(\_
    \end{subsolution}
\end{solution}
